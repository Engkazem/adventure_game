...
def combat(weapon):
    ...
    if weapon == "dagger":
        print_pause(f"with onh only having a tiny {weapon}, "
...
# Playler will choose where to go house or cave
def where_to():
    print_pause("")
...
def house():
    ...
    print_pause(f"The door opens and out steps a {enemy}, "
                "When you are about to knock.")
